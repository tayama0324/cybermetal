...
export default function Page() {
  return (
    <Pagination page={999}>
      ...
      <p>さて、外転神経がバグっていることはわかったものの、ここからどうするか？ドクターの次の一手は脳のMRI（核磁気共鳴）検査でした。複視の原因として脳卒中など脳の病気が考えられます。仮にこれらが原因だとすると筆者はいつ死んでもおかしくないので、最優先で検査する必要があるわけです。ここで着目すべきは、一番ありそうな原因から先に調べているわけではないということです。おそらく脳がハズレであろうことは素人である筆者にも分かっていました。この症状は10年以上も前からだんだん悪化していったものなので、もし脳卒中だとすると筆者はとっくに死んでいるはずだからです。これはつまり、タスクの重要度と緊急度を分けて考えているわけですね。合理的！時期は前後しますが、後に予想通りこのMRI検査の結果は正常だと判明することになります。</p>
