...
export default function Page() {
  return (
    <Pagination page={999}>
      ...
      <p>結局、根本的な原因は分からずじまいでした。こういった原因不明の複視は最近増えているそうです。ゲームを長時間する人に多いということですが、筆者はそうでもありません（日がな一日PCの前にはいますが）。寝る前に眼鏡を外し、至近距離でスマホを見ることが多いことが原因なのではと思いましたが（その癖がついた頃に複視が悪化したような気がするので）、近くで見ることはむしろ眼を休める方向に働くとドクターは言います。</p>
      <p>ググってみると、複視の原因についての記事がいくつかヒットします[^3][^4] 。これらのうち、脳腫瘍や脳梗塞などはMRIで除外しました。眼球運動の物理的阻害も除外済みです。ボツリヌス症やギラン=バレー症候群などは全身性の症状がないことから除外できそうです。重症筋無力症には全身型と眼筋型があり、後者はありえそうに見えますが、眼瞼下垂（がんけんかすい：まぶたに力が入らず垂れ下がること）がないこと、血液中のアセチルコリン受容体抗体に異常がないことは不自然です。また仮に重症筋無力症だったとして、その治療は副作用の強い投薬になるようです。であれば眼鏡の矯正で済ませようという話になってきますし、重症筋無力症としての治療を行うつもりが最初からないのであれば、重症筋無力症かどうかに興味を持つ意義もありません。</p>
