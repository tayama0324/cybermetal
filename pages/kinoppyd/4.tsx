...
export default function Page() {
  return (
    <div>
      ...
      <h3>焼酎・泡盛</h3>
      <p>
        焼酎は日本で造られているお酒で、米、麦、芋などの原料を使っています。泡盛はタイ米を原料としています。酒税法では単式蒸留と連続蒸留をした場合の要件が定められており、それぞれ単式蒸留焼酎と連続式蒸留焼酎と呼ばれています[5]。一般的には、昔の酒税法の区分である乙類（本格焼酎）、甲類という呼び方が有名です。名前からわかるように、原料の風味を残すように作られた単式蒸留の焼酎は本格と呼ばれ、焼酎単体で飲むことが多いです。一方で、雑味の少ない連続式蒸留焼酎は割り材として使用されることが多いです。泡盛は法律での制限はありませんが、ほぼ全てが単式蒸留で作られています。
      </p>
      <p>
