...
export default function Page() {
  return (
    <Pagination page={15}>
      ...
      <p>
        グレーンウイスキーは、原料の風味をあまり残さずすっきりと仕上げるために、連続蒸留が行われます。一回の蒸留で純度の高いエタノールを取りだしますが、アメリカのバーボンなどは原料の風味を残すべく精製されるエタノールの濃度を８０パーセント以下にするよう法律で決められたりしています。アメリカ、カナダではこの方法がメインでウイスキーが作られており、スコットランド、アイルランド、日本、台湾、インドでもブレンド用のウイスキーとして一部で作られています。
      </p>
      <h3>焼酎・泡盛</h3>
      <p>
