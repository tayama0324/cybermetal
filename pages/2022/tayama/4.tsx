...
export default function Page() {
  return (
    <Pagination page={8}>
      ...
      <Image href={'/2022/tayama/4.png'} description={'Figure 4. 夜に駆ける'} />
      <Image href={'/2022/tayama/5.png'} description={'Figure 5. 威風堂々（第一番中間部）'} />
      <p>
      ...
      <Image href={'/2022/tayama/6.png'} description={'Figure 6. ワンダーステラ'} />
      <p>
