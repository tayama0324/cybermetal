  ...
  return (
    <div>
      <p>
        ...
        バスではあるのだが、様々な工夫によって電車と遜色ない定時運行が可能となっており、料金も安く、有明~新橋を10分強で移動できる予定。
        築地市場跡地で工事が進められていた環状第2号線トンネルも完成したので混雑解消、BRTが接近すると信号機が青になるような特権もあるとかないとか。
      ...
      <p>
        ...
        スーパーはもちろん、大型書店、スポーツ用品、マッサージ店、アパレル店など多数。飲食店街とフードコートは選択肢が豊富。
        関東最大の無印良品、天然温泉が楽しめる泉天空の湯、8000人収容可能な東京ガーデンシアター、ライオンキング公演中の劇団四季劇場も併設。
        コミケ参加者は国際展示場駅を出て右に曲がると思うが、左に曲がって徒歩２〜３分の場所に有明ガーデンがあるので是非帰りにでも行ってみて欲しい。
      </p>
      <p>
        これから先の開発計画も期待度が高い。
      ...
      <p>
        ...
        FormuraEはF1の電気自動車版であり、街中がF1会場になると噂されている。またも有明が世界から注目される街になるのは興味深い。
      </p>
      <p>
