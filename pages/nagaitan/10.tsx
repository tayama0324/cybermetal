...
export default function Page() {
  return (
    <div>
      ...
      <p>また、重要な検査として風しん抗体検査があります。妊婦が風疹にかかると、赤ちゃんが目や耳、心臓などに先天性の障害をもつ「先天性風疹症候群」になる可能性があります。特に1962年4月2日から1979年4月1日生まれの男性は、学校で風疹の定期接種を受ける機会がなかった世代であり、風しんにかかるリスクが高く、妊婦にうつしてしまう恐れがあります。風しんの抗体検査と予防接種は無料で受けられる自治体が多いので、子どもをもつことを考える人は男女とも抗体検査を受けておきましょう。（妊婦の場合は妊婦健診に組み込まれているかと思います）</p>
      <h2>4. 終わりに</h2>
      ...
      <p>そして子どもが欲しいけどなかなかできない、パートナーと話し合うきっかけがつかみにくい、などと悩んでいる人がいたら、ぜひ不妊治療という選択肢を考えてみて欲しいと思います。不妊治療クリニックに行くと、こんなに多くの人が子どもができなくて悩んでいるのかと驚きます。まずは気軽な気持ちで、一歩踏み出してみていただければ幸いです。</p>
